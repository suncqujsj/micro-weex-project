  ...
  <div class="wrapper" @viewappear="viewappear" @viewdisappear="viewdisappear">
   <div>
    ...
    <div class="standby_section _relative">
     ...
     <div class="flex_center mode_show">
  ...
  methods: {
     analysisFun(analysisObj) {
      ...
      if(analysisObj.displaySign.detail.doorSwitch.value==0){
       ...
       var piaoWashTemp = analysisObj.piaoWashTemperature.value;
       var diyData = analysisObj.washingTimes.value;
       var diyModeTime = 100;
       self.mode = program;
      switch (program) {
        case 1:
