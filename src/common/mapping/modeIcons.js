...
icons[25] = getIcon('快蒸', 'quick_steam@3x');
icons[26] = getIcon('变频加热', 'microwave@3x');
icons[27] = getIcon('快捷微波', 'microwave@3x');
icons[28] = getIcon('保温', 'heat_preservation@3x');
icons[29] = getIcon('变频加热', 'microwave@3x');
icons[30] = getIcon('自动菜单', '');
icons[31] = getIcon('热风烧烤', 'hot_wind_and_broil@3x');
icons[32] = getIcon('旋转烧烤', 'rotate@3x');
...
icons[48] = getIcon('慢蒸', 'slow_steam@3x');

icons[49] = getIcon('餐具清洁', 'dining_utensil_clean');
