       ...
       callClick(event,num) {
       	if(num == 1) {
       		if(this.chartColor == "#FFAACC") {
       			this.chartColor = "dark"
       		} else {
       			this.chartColor = "#FFAACC"
       		}
       	} else if(num == 2) {
       		if(this.chartColor1 == "blue") {
       			this.chartColor1 = "dark"
       		} else {
       			this.chartColor1 = "blue"
       		}
       	} else if(num == 3) {
       		if(this.chartColor2 == "red") {
       			this.chartColor2 = "dark"
       		} else {
       			this.chartColor2 = "red"
       		}
       	} else if(num == 4) {
       		if(this.chartColor3 == "yellow") {
       			this.chartColor3 = "dark"
       		} else {
       			this.chartColor3 = "yellow"
       		}
       	} else if(num == 5) {
       		if(this.chartColor4 == "#FFAACC") {
       			this.chartColor4 = "dark"
       		} else {
