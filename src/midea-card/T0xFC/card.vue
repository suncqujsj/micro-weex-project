	        ...
	        <div  v-if="onlineStatus == '1'">
		    	 <div class="card" v-if="onoff == 'on'">
		        	...
		        	<div class="card-right">
		        		...
		        		<div class="card-icon" >
		        			<image class="card-icon-img" @click="showControlPanelPage" src="./assets/img/smart_img_equip033@2x.png"></image>
		        		</div>
		        		<div></div>
		        ...
		        <div class="card-power-off" v-else>
		        	...
		        	<div >
		        		<image @click="showControlPanelPage" class="icon-offline" src="./assets/img/smart_img_equip033@2x.png"></image>
		        	</div>
		        </div>
	        </div>
	        <div class="card-power-off" v-else>
