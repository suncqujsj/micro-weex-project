    ...
    <div class="contain">
      ...
      <div class="">
        <slider class="slider" auto-play="false" infinite="false">
          <div v-for="item in posters" style="width:750px">
            
            <div class="flex_center">
              <image class="size" :style="{width:item.slideWidth,height:item.slideHeight}" :src="item.url"></image>
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      slideHeight: '900',
       posters: [
          {url:'img/tips/img_attention1@2x.png',order:'01',slideWidth:'628px',slideHeight:'910px'},
            {url:'img/tips/img_attention2@2x.png',order:'02',slideWidth:'673px',slideHeight:'972px'},                   
        ]
    };
  },
