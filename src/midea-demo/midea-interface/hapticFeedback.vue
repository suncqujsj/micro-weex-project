<template>
    <div class="wrapper">
        <midea-header title="getUserInfo" :isImmersion="isImmersion" @leftImgClick="back"></midea-header>
        <midea-button text="执行hapticFeedback" @mideaButtonClicked="mideaButtonClicked">
        </midea-button>
