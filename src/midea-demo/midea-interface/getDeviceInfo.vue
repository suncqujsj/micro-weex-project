<template>
    <div class="wrapper">
        <midea-header title="getDeviceInfo" :isImmersion="isImmersion" @leftImgClick="back"></midea-header>
        <midea-button text="执行getDeviceInfo" type="green" @mideaButtonClicked="mideaButtonClicked">
        </midea-button>
