	        ...
	        <div v-if="onlineStatus == '1'" @click="showControlPanelPage">
		    	 <div class="card" v-if="onoff == 'on'">
		        	<div class="card-left">
	        			...
	        			<text class="main-status-second">设置湿度</text>
		        		<div class="card-status-detail">
		        			<text class="main-status-third">{{wind_speed}}</text>
		        		</div>
		        	</div>
		        	<div class="card-right">
		        		...
		        		<div class="card-icon" >
		        			<image class="card-icon-img"  resize="contain" src="./assets/img/smart_img_equip027@3x.png"></image>
		        		</div>
		        ...
		        <div class="card-power-off" v-else>
		        	...
		        	<div>
		        		<image  class="icon-offline" src="./assets/img/smart_img_equip027@3x.png"></image>
		        	</div>
		        </div>
	        </div>
	        <div class="card-power-off" v-else>
