    ...
    <div class="working_box" ref="modeBox">
     ...
     <div class="working_section">
       <div class="flex_center" style="margin-top:30px">
          <text class="_dec">{{modeDec}}</text>
          <text v-if="hasFunctionOptions" class="_dec">  （ 少量 ）</text>
        </div>
       ...
       <div v-if="!workEnd" class="flex_center" style="margin-top:100px">
...
export default {
  ...
  methods: {
    analysisFun(analysisObj) {
      ...
      self.hasFunctionOptions = analysisObj.functionOptions.value;
      ...
      switch (program) {
        ...
        case 11:
          self.modeDec = "水果洗";
          self.modeImg = "assets/img/sel_mode/program_all_icon_fruits@2x.png";
          self.yuXi = true;
          self.yuXiNext = self.zhuXi = self.zhuXiNext = self.piaoXi = self.piaoXiNext = self.gaoZao = false;
          break;
        case 12:
          self.modeDec = "自定义洗";
          self.modeImg = "assets/img/sel_mode/setting_diy.png";
          var washTime = parseInt(analysisObj.washingTimes.value);
          if(washTime < 3){
             self.yuXi = true;
             self.yuXiNext = self.zhuXi = self.zhuXiNext = self.piaoXi = self.piaoXiNext = self.gaoZao = false;
          }else{
