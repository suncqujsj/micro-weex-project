<template>
    <div>
        ...
        <heater-confirm-box :height='670' :show="show" @mideaPopupOverlayClicked='cancel'>
...
import heaterConfirmBox from '@/midea-component/newComp/heaterConfirmBox2.vue'
export default {
    components:{heaterCell,heaterConfirmBox,mideaButton},
    mixins:[base],
    data(){
        return {
            show:true
