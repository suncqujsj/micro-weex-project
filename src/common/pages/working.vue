...
<template>
    <div  class="all_section"  @viewappear="viewappear(tabs)" @viewdisappear="viewdisappear">
        <midea-header bgColor="transparent" leftImg="assets/img/header/public_ic_back@3x.png" title="蒸汽炉" titleText="white" :isImmersion="true"  :showLeftImg="true" @leftImgClick="goBack"></midea-header>
