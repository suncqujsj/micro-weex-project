            ...
            [
                ...
                },
                {
                    ...
                    detail: {
                        ...
                        '2.把虾仁装入碗中，放入洗净的花蛤肉，淋入少许料酒，加盐、鸡粉，拌匀，腌渍约10分钟。end'+
            ...
            [
                ...
                },
                {
                    ...
                    detail: {
                        ...
                        '4.放入洗净的百合，撒上洗好的枸杞、姜片，加入少许盐、鸡粉，淋入适量料酒、生抽、油、生粉，搅拌均匀后腌制约15分钟。end'+
                        '5.把蒸盘/烤架放入腔体第一层，把装食物的碟子放入蒸盘中间，水盒加水，选择菜单，启动即可。end'+
                        '6烹饪结束后取出，.趁热撒上葱花即成。'
                    }
                },
                {
                    ...
                    detail: {
                        ...
                        '2.在装有牛肉的碗中，放入芝麻油、姜末、鸡粉、生抽、葱花、盐，搅拌均匀，加入2勺清水，同方向搅拌均匀，制成馅料待用；end'+
