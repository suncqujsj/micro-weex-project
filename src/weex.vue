...
module.exports = {
  ...
  data: () => ({
    ...
    moduleIndex: null,
    moduleList: [
      { key: -11, value: "T0xB4", desc: "小烤箱合包" },
      { key: -10, value: "T0x9B", desc: "9B" },
      ...
      { key: 2, value: "community", desc: "community 社区模块" },
      { key: 3, value: "midea-rooms", desc: "midea-rooms场景" },
      { key: 4, value: "customer-service", desc: "customer-service 服务模块" },
      { key: 5, value: "T0xB4_08T7428E", desc: "fun烤箱（直播）" },
      { key: 6, value: "T0xB1_0TVN50R6", desc: "E厨R6大烤箱" },
      { key: 7, value: "T0xB2_0TPN50R6", desc: "R6 蒸汽炉" },
      { key: 8, value: "T0xB1_0D50S3AT", desc: "双腔体" },
      { key: 9, value: "T0xB0_0M3L20A8", desc: "年轻套系20L微波炉" },
  ...
  created() {
    nativeService.getItem("demo_target_history", resp => {
      if (resp.result == "success" && resp.data) {
        ...
        this.history.push(
          "http://qrcode.midea.com/tests/weexDemo/weex.js?root=midea-demo&isDummay=false"
        );
      }
