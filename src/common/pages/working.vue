...
<template>
    <div  class="all_section"  @viewappear="viewappear(tabs)" @viewdisappear="viewdisappear">
        <midea-header bgColor="transparent" leftImg="img/header/public_ic_white.png" :title="constant.device.title_name" titleText="white" :isImmersion="true"  :showLeftImg="true" @leftImgClick="back2Native"></midea-header>
...
<script>
    ...
    export default {
        mixins: [deviceMessageMixin, accordionMixin, workingData,detailModalMixin,copyMixin],
        data(){
            return {
       ...
       props: {
        ...
        components: {MideaHeader, mideaDialog, mideaActionsheet,sfDialog,WxPicker,modalHeader,detailModal,sfAccordion,mideaSwitch2},
        created(){
            var self = this;
