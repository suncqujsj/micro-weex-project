<template>
    ...
    <scroller class="box">
    	 <div>
	    	 <div class="card">
	        	<div class="card-left">
	        		<div style="flex-direction: column;"><text class="main-status">24</text><text class="main-status-second" style="text-align: center;">室内温度</text></div>
	        	...
	        	<div class="card-right">
	        		<div style="align-items: flex-end;margin-top:32px;margin-right:32px"><image style="width:48px;height:50px" src="./assets/img/smart_ic_power@2x.png"></image></div>
	        		<div style="align-items: flex-end;margin-top:-60px;margin-right:-24px"><image style="width:282px;height:160px" src="./assets/img/test_ic_one@2x.png"></image></div>
	        		<div></div>
