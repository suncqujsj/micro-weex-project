...
<script>
    import sfTab from '@/midea-component/sf/custom/headerTab.vue'
    import sfHeader from '@/midea-component/sf/custom/header.vue'
    ...
    import mideaDialog from '@/midea-component/sf/custom/dialog_tips.vue'
