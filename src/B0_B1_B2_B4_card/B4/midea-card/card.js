...
var _card = __webpack_require__(289);
...
__vue_options__.__file = "D:\\Project\\美居\\midea-weex-cards\\midea-weex-cards\\src\\midea-card\\T0xB4\\card.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-6c73ecaf"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _mock = __webpack_require__(292);
...
exports.default = {
    ...
    methods: {
        mideaClick: function mideaClick(event) {
    ...
    computed: {
        powerOnoffImg: function powerOnoffImg() {
            var img = "./assets/img/smart_ic_play@2x.png";
            if (this.power == "on") {
        ...
        statusImg: function statusImg() {
            var img = "./assets/img/smart_ic_cold_on@3x.png";
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('scroller', {
    ...
    staticClass: ["box"]
  }, [_c('div', [(_vm.onlineStatus == '1') ? _c('div', {
    staticClass: ["card"],
    on: {
    ...
    class: [_vm.work_status != 'work' ? 'main-status-simple' : '']
  }, [_vm._v(_vm._s(_vm.display_value1))]), _c('text', {
    staticClass: ["danwei"]
  }, [_vm._v(_vm._s(_vm.danwei))])]), _c('text', {
  ...
  }, [_vm._v(_vm._s(_vm.work_mode))])])]), _c('div', {
  ...
  return _c('div', {
    ...
    attrs: {
      "resize": "contain",
      "src": "./assets/img/smart_img_equip042@3x.png"
    }
  })])
