            ...
            [
                ...
                },
                {
                    ...
                    detail: {
                        ...
                        cookingSteps:
                            '1.准备好所有食材。\n' +
                            '2.豆腐切成1.5厘米的正方体，猪肉剁碎，蒜苗斜切段，葱切碎，淀粉加水搅拌均匀备用。\n' +
                ...
                },
                {
                    ...
                    detail: {
                        ...
                        cookingSteps:
                            ...
                            '4.取一个微波适用的深盘，平铺上五花肉，不加盖放入微波炉底盘，微波高火加热5分钟。\n' +
                            '5.取出五花肉，加入青红椒、蒜苗，倒入酱汁拌匀，加盖留孔放入微波炉中，微波1000W火力加热5分钟。',
                    },
                    settingHide:true
                },
                {
                ...
                },
                {
                    ...
                    detail: {
                        ...
                        cookingSteps:
                            '1.准备好所有食材。\n' +
                            '2.把乌鸡块焯水备用。\n' +
                            '3.把焯水后的乌鸡块放在饭煲里，加入红枣、枸札、黄芪和水，加盖放入微波炉中，选择菜单，启动即可。\n' +
                            '4.烹饪结束后根据个人口味调入食盐即可。' ,
                    },
                    settingHide:true
                },
                {
                    ...
                    detail: {
                        ...
                        cookingSteps:
                            ...
                            '2.将虫草花洗净，放碗里浸泡备用。\n' +
                            '3.将排骨焯水后捞起清洗干净血水。\n' +
                            '4.焯水后的排骨放进大而深的宽口微波适用容器中，加入虫草花和枸杞子，加入1000ml水加盖，放入微波炉中，关门。 \n' +
                            '5.最后根据个人口味调入食盐即可。',
                    },
                    settingHide:true
                },
                ...
                },
                {
                    ...
                    detail: {
                        ...
                        cookingSteps:
                            ...
                            '8.取出一份抹茶面团，用擀面杖再次擀成长牛舌状，约1.5-2个手掌的长度。从下往上端卷起来，收口朝下，盖好保鲜膜。\n' +
                ...
                },
                {
                    ...
                    detail: {
                        ...
                        cookingSteps:
                            ...
                            '8.每个都卷好后，收口朝下，盖上保鲜膜松弛15分钟。然后再重复一次，取一个卷好的面团，收口朝上，用擀面杖上下方向擀开成牛舌状，约1.5-2个手掌的长度，将面皮从上往下卷起来。每个都卷好后，收口朝下，盖上保鲜膜继续松弛15分钟。\n' +
                ...
                },
                {
                    ...
                    detail: {
                        foodMaterial:
                            ...
                            '热水 10g' ,
                        cookingSteps:
                            '1.可可粉加水混合均匀备用，蛋清、蛋黄分离备用。\n' +
                            '2.蛋黄搅匀后加入牛奶和玉米油，搅拌均匀，筛入面粉，搅拌均匀。\n' +
                            '3.用打蛋器将蛋白打发至粗泡，然后分三次加入细砂糖，打发至尖角状。\n' +
                            '4.取三分之一蛋白加入到蛋黄糊中，翻拌均匀，再去三分之一加入，翻拌均匀。\n' +
                            '5.倒入剩余的蛋白中，翻拌均匀。\n' +
                            '6.取一半蛋糕糊，加入准备好的可可粉糊，翻拌均匀。\n' +
                            '7.一勺原糊一勺可可糊，一次交错，并轻轻震出大气泡。\n' +
                            '8.选择自动菜单预热，预热结束后，烤盘放入微波炉第1层（取出倒扣在烤架上放凉后再脱模）。' ,
                    },
                    settingHide:true
                },
                {
