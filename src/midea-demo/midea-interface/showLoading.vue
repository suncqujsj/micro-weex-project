<template>
    <div class="wrapper">
        <midea-header title="showLoading" :isImmersion="isImmersion" @leftImgClick="back"></midea-header>
        <midea-button text="执行showLoading" @mideaButtonClicked="mideaButtonClicked">
        </midea-button>
