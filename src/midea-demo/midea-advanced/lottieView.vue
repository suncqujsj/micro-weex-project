<template>
    <div class="wrapper">
        ...
        <scroller>
            <div>
                <midea-lottie-view v-if="lottieData" ref="lottieView" class="lottie" :data="lottieData" :loop="true"></midea-lottie-view>
            </div>
...
export default {
    ...
    mounted() {
        this.lottieData = JSON.stringify(this.lottieDemo[5])
    }
}
</script>