<template>
    <div>
        <div @touchend="handleTouchEnd">
            <midea-overlay :show="haveOverlay && isOverShow" v-if="show" ref="overlay" v-bind="overlayCfg" v-on:mideaOverlayBodyClicked="mideaOverlayBodyClicking"></midea-overlay>
        </div>
        <div ref="midea-confirm" v-if="show" :height="_height" :hack="isNeedShow" :class="['midea-confirm', pos]" :style="padStyle">
            <div class="confirm-content-wrapper">
                <text class="confirm-content">{{content}}</text>
                <slot></slot>
                <div class="confirm-buttons-floor">
